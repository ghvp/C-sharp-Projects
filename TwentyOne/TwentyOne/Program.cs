...
//every data type in c# is either a reference type or value type they have different behaviors
namespace TwentyOne
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya") 
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\vivienne\logs\log.txt", true)) 
                {
        ...
        private static void UpdateDbWithException(Exception ex) 
        {
            ...
            string queryString = @"INSERT INTO dbo.Table (ExceptionType, ExceptionMessage, TimeStamp) VALUES (@ExceptionType, @ExceptionMessage, @TimeStamp)";
